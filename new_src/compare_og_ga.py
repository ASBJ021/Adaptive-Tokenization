...
from genetic_algo.clip_model import load_clip, forward_with_selected_patches
from visual_utils import plot_heatmap_overlay  # for consistent heatmap coloring
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default=os.path.join(os.path.dirname(__file__), "compare_outputs"), help="Directory to save outputs")
